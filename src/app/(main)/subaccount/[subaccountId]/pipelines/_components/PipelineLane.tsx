...
import PipelineTicket from '@/app/(main)/subaccount/[subaccountId]/pipelines/_components/PipelineTicket'
...
const PipelineLane: React.FC<PipelaneLaneProps> = ({setAllTickets, tickets, pipelineId, laneDetails, subaccountId, allTickets, index,}) => {
    ...
    const laneAmt = useMemo(() => {
        ...
        return tickets.reduce(
            (sum: any, ticket: Ticket) => sum + (Number(ticket?.value) || 0),
            0
        )
    }, [tickets])
